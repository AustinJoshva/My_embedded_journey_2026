...
* Converting any text into Morse code
* Adding a buzzer for sound output
* Supporting the full alphabet and numbers
* Making the code cleaner and more efficient

## Note

I'm just getting started with embedded systems, so there are definitely things I can improve. If you have any suggestions or feedback, I'd love to hear them!
